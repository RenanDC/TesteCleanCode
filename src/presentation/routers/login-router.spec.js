...
describe('Login Router', () => {
    ...
    test('Should return 200 AuthUseCase with correct params', async () => {
    ...
    test('Should return 500 if no AuthCase throws', async () => {
    ...
    test('Should return 200 EmailValidator with correct params', async () => {
        const { sut, emailValidatorSpy } = makeSut()
        const httpRequest = {
            body: {
                email: 'any_email@gmail.com',
